...
//{
//	public abstract class AssetBundleLoadOperation : CustomYieldInstruction
//    {
...
//				return false;
//
//			Debug.LogFormat ("<color=orange>{0}, {1}, {2}, {3}, {4}, </color>", m_WebRequest.url, m_WebRequest.downloadProgress, m_WebRequest.isDone, m_WebRequest.isError, m_WebRequest.downloadedBytes);
//
//			return !IsDone();
//		}
//
...
//				Debug.LogFormat("An error has occurred during loading asset from {0}: {1} {2} {3}", m_Url, m_WebRequest.error, m_WebRequest.isDone, m_WebRequest.isError);
//
//				if (m_WebRequest.isDone && !m_WebRequest.isError && (HttpStatusCode)m_WebRequest.responseCode == HttpStatusCode.OK) {
